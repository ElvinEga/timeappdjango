...
class AccountAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'balance', 'date_added', 'date_modified')

class TransactionAdmin(admin.ModelAdmin):
    list_display = ('id', 'transact_account', 'sender', 'receiver', 'amount', 'transaction_type', 'date_added', 'date_modified')
